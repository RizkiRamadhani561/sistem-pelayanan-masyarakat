...
<head>
    ...
    <title>Detail Warga - Dashboard Admin</title>
        ...
        <div class="row mb-4">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="h3 mb-1">
                            <i class="fas fa-user-circle text-primary me-2"></i>Detail Warga
                        </h2>
                        <p class="text-muted mb-0">Informasi lengkap data warga</p>
                    </div>
