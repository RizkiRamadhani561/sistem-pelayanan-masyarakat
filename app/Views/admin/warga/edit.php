...
<head>
    ...
    <title>Edit Warga - Dashboard Admin</title>
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/dashboard/warga" class="text-decoration-none"><i class="fas fa-users me-1"></i>Kelola Warga</a></li>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="h3 mb-1">
                            <i class="fas fa-user-edit text-warning me-2"></i>Edit Data Warga
                        </h2>
                        <p class="text-muted mb-0">Perbarui informasi warga dalam sistem</p>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="/dashboard/warga/<?= $warga['id_warga'] ?>" class="btn btn-outline-primary">
                            <i class="fas fa-eye me-1"></i>Lihat Detail
                        </a>
                        <a href="/dashboard/warga" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    ...
                    <div class="card-body current-data">
                        <div class="row">
                            <div class="col-md-3">
                                <strong>NIK:</strong>
                                <code class="text-primary ms-2 fs-6"><?= htmlspecialchars($warga['nik']) ?></code>
                            </div>
                            <div class="col-md-3">
                                <strong>Nama:</strong>
                                <span class="ms-2 fw-semibold"><?= htmlspecialchars($warga['nama_lengkap']) ?></span>
                            </div>
                            <div class="col-md-3">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <!-- Form -->
                        <form action="/dashboard/warga/<?= $warga['id_warga'] ?>/update" method="post" id="editForm">
                            <?= csrf_field() ?>
